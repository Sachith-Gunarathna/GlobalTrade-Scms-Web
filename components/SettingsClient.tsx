      ...
      {activeTab === 'api' && (
        <div className="settings-panel glass-panel">
          ...
          <div className="integrations-grid">
            ...
            <div className="integration-card connected"><div className="int-top"><div className="int-icon green"><ShieldCheck size={18} /></div><span className="int-status"><CheckCircle2 size={13} /> Secured</span></div><h4>Role Authorization</h4><p>Application role checks protect logistics, warehouse, customs, and vendor operations.</p></div>
